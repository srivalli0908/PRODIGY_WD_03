...
function myfunc() {
	...
	if ((b1 == 'x' || b1 == 'X') && (b2 == 'x' ||b2 == 'X') && (b3 == 'x' || b3 == 'X')) {
		...
		b1btn.style.color = "yellow";
		b2btn.style.color = "yellow";
		b3btn.style.color = "yellow";
	}
		...
		b1btn.style.color = "yellow";
		b4btn.style.color = "yellow";
		b7btn.style.color = "yellow";
	}
		...
		b7btn.style.color = "yellow";
		b8btn.style.color = "yellow";
		b9btn.style.color = "yellow";
	}
